...
def train(train_file, dev_file=None, test_file=None):
    reader_train = reader(train_file, language='chn')
    #reader_test = reader(test_file, language='chn')
    sents_train = reader_train.getWholeText()
    #print(sents_train[:50])
    #sents_test = reader_test.getWholeText()
    train_posts, train_responses, train_labels = reader_train.getData()
    train_post_response_label = mergePostResponseLabel(train_posts, train_responses, train_labels)
    #print('train_posts******\n', train_posts[:10])
    #print('train_responses******\n', train_responses[:10])
    #print('train_labels******\n', train_labels[:10])
    #print(train_post_response_label[:50])
...
#path = './Data/Chinese/short_conversation_corpus/stanceResponse.train'
